...
function saveLanguage(nextLanguage: Language) {
  ...
  try {
    localStorage.setItem("terminal-blog.language", nextLanguage);
  } catch {
    // The current-page choice remains available when browser storage is unavailable.
  }
